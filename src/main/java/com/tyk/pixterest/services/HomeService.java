...
public class HomeService {
    ...
    public Set<Integer> getSavedPinIdsByUser(UserEntity user) {
        List<Integer> pinIds = pinUserSaveMapper.selectPinIdsByUserEmail(user.getEmail());
        return new HashSet<>(pinIds);
    }
